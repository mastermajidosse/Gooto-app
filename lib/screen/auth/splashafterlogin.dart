...
class SplashScreenafterauth extends StatefulWidget {
  static const routeName = 'SplashScreen';

  final double radius;
  final double dotRadius;

  SplashScreenafterauth({this.radius = 50.0, this.dotRadius = 10.0});
  @override
  _SplashScreenState createState() => _SplashScreenState();
}

class _SplashScreenState extends State<SplashScreenafterauth> with SingleTickerProviderStateMixin {
