...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p style="color: #444;text-align:justify">${'Surf lessons can be a fun and rewarding way to learn a new sport, and can provide a sense of accomplishment and enjoyment for people of all ages and abilities.'.tr()}</p>
        </div>
    </div>
</body>
""",
        ...
        previewImgs: [
          "assets/popular/skydiving1.jpg",
          "assets/popular/skydiving2.jpg"
        ]),
    BlogModel(
        title: 'Merzouga: 3-Day Desert Safari with Food',
        price: '\$110 per person',
        desc:
            """<p style="color: #444;text-align:justify">${'Experience the Moroccan Sahara Desert on a 3-day safari tour from Marrakech to Merzouga. Spend the night at a Bedouin camp in the Erg Chebbi dunes. Ride a camel to watch the sunset and sunrise. See the Kasbah of Ouarzazate, and much more.'.tr()}</p>
          """,
        imgurl:
    ...
    BlogModel(
        ...
        desc:
            """<p style="color: #444;text-align:justify">${'Summiting Mount Toubkal—North Africa’s highest peak—is a rewarding experience, and one that, because it requires no technical climbing, is accessible to most travelers with reasonable fitness. With this tour, ascend at your own pace and receive undivided attention and one-on-one support from a private guide. Most of the planning, from arranging transport to overnight accommodation and mules to carry packs, is done for you.'.tr()}</p>,""",
        imgurl:
    ...
    BlogModel(
        ...
        desc:
            """<p style="color: #444;text-align:justify">${"On an action-packed day trip from Marrakesh, enjoy camel riding and quad biking in the Agafay desert. Enjoy views of the desert and Berber hospitality with a traditional meal. Take advantage of the hotel pickup service and head to the base camp for a meeting with your entire crew. Your tour's itinerary will be explained to you by your crew leader. Then, meet your guide and don a nomadic outfit before embarking on a scenic camel ride across the desert. Ride your camel across the desert. Then, hop on a quad bike and find a vantage point to take in the Agafay Desert's unique beauty at sunset. Relax and take in the scenery, as well as the genuine Moroccan hospitality. Finish your day by sitting under a Berber tent and gazing at the stars, as a delicious traditional meal is served".tr()}.</p>""",
        imgurl:
    ...
    BlogModel(
        ...
        desc:
            """<p style="color: #444;text-align:justify">${"Paintball is considered to be a fun activity that consolidates the values of group work, whether it is between family members, friends, or colleagues. It has a strong strategic dimension, energizes teams, and improves communication between its members. These elements strengthen existing links and, in the end, pleasure and joy prevail.".tr()}</p>
         <p style="color: #444;text-align:justify">${"Paintball offers three paintball fields with different configurations and movable obstacles. It's a friendly space to bring together your relatives, friends, or colleagues in a setting where good humor reigns.".tr()}</p>""",
        imgurl:
    ...
    BlogModel(
        ...
        price: 'from £286.24 per adult',
        desc:
            """<p style="color: #444;text-align:justify">${"Fly through the sky over the Atlas Mountains on this private skydive experience from Marrakech. You’ll have a vantage point not many ever get to see with this excursion. You’ll be collected from your hotel in Marrakech for ease, then taken to the skydive site. You’ll have instruction and equipment provided, so you’ll be ready for your exhilarating flight.".tr()}.</p>""",
        imgurl:
